    ...
    <div class="row">
      <div class="col-md-8">
        <div class="box-holder">
          ...
          <form role="form" class="live_form" id="create-poll" method="post" action="<?php echo Main::href("createsurvey") ?>">
            <div id="container_questions" class="tabbed">
              <div class="form-group">
                <label for="questions"><?php echo e("Your Survey Title")?></label>
			  ...
			  <?php */?>
			  <!--<button type="button" data-id="customize" class="btn btn-primary tabs"><?php echo e("Customize")?> &rarr;</button>-->
			  <input type="hidden" name="is_parent" id="is_parent" value="1" />
			  <button type="submit" class="btn btn-primary"><?php echo e("Next")?></button>
            </div>     
