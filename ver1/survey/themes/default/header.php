...
<?php
global $title, $logo, $desc, $bg_type, $bg_color, $bg_image, $keywords, $image_style, $about_desc, $domain,$domain_affiliate_link, $partners, $sitename, $account_ga, $piwik_id, $footer_banner;
?>
...
<html lang="en" prefix="og: https://ogp.me/ns#">
  <head>    
	...
	<?php 
		$str_googleanalytics = $this->config["googleanalytics"];
		$str_googleanalytics = str_replace("ga('create', 'UA-47677208-2', 'msurvey.com');","ga('create', '$account_ga', '$sitename');",$str_googleanalytics);
		echo $str_googleanalytics;
	?>
  <!-- Piwik -->
        ...
        <div class="container">
          <div class="row widget">
              <div class="col-md-8 promo">
                <h2 class="lander-head-title"><?php echo e("Free. Simple. Viral.") ?></h2>
                ...
                <a href="<?php echo Main::href("create") ?>" class="btn btn-primary btn-lg"><?php echo e("Create your Survey") ?></a>
              </div>
              <div class="col-md-4">
                <div class="box-holder">
                  ...
                  <form role="form" class="live_form" method="post" action="<?php echo Main::href("user/register") ?>">
                    ...
                    <p class="help-block"><?php echo e("By creating an account you accept our") ?> <a href="<?php echo $this->config["url"] ?>/terms" target="_blank"><?php echo e("terms and conditions") ?></a>.</p>                                      
