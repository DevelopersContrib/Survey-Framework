    ...
    <div class="row">
      <div class="col-md-5">
        <div class="box-holder">
          ...
          <form role="form" class="live_form" id="create-poll" method="post" action="<?php echo Main::href("create") ?>?pid=<?php echo $_REQUEST['pid']?>">
			...
			<div id="container_questions" class="tabbed">
			  ...
			  <div class="form-group">
                <label for="image_url"><?php echo e("Image URL")?></label>
                <span class="help-block"><?php echo e("Optional image url")?></span>
                <input placeholder="http://example.com/example.png" type="text" class="form-control" id="image_url" name="image_url">
              </div>
              ...
              <button type="button" data-id="customize" class="btn btn-primary tabs pull-right"><?php echo e("Customize")?> &rarr;</button>
            ...
            <div id="customize" class="tabbed">       
              ...
              <button type="button" data-id="container_questions" class="btn btn-success tabs">&larr; <?php echo e("Questions")?></button>
              <button type="button" data-id="theme" class="btn btn-primary tabs pull-right"><?php echo e("Theme")?> &rarr;</button>              
            </div>    
            <div id="theme" class="tabbed">         
              ...
              <div class="form-group">
                <label for="font"><?php echo e("Font")?></label>
                <select id="font" name="font" class="choose_font">
                  <option value="null"><?php echo e("Default")?></option>
                  <?php $fonts=json_decode($this->config["fonts"],TRUE) ?>
                  <?php foreach ($fonts as $font): ?>                  
                    <option value="<?php echo strtolower(str_replace(" ","_", $font)) ?>"><?php echo $font ?></option>
                  <?php endforeach ?>
                </select>
              </div>
			  <div class="form-group">
                 <img style="border: 1px solid #0000ff;" src="/captcha1/">
                <input style="width:150px;display:inline" placeholder="" class="form-control" id="captcha1" name="captcha1" type="text">
  
				<span for="image_url">Are you human?</span>
              </div>
              <?php //echo Main::captcha() ?>                   
              <button type="button" data-id="customize" class="btn btn-success tabs">&larr; <?php echo e("Customize")?></button>
              <?php echo Main::csrf_token(TRUE) ?>
              <input type='hidden' value='<?php echo $_REQUEST['pid'];?>' name="pid" id="pid" />
			  <input type='hidden' value='0' name="another" id="another" />
			  <!--<button id="btn-create" type="submit" class="btn btn-primary pull-right"><?php echo e("Create")?></button> -->                
				<div class="pull-right">
					<button id="btn-create" type="submit" class="btn btn-primary ">Save</button>
					<button id="btn-create-another" type="submit" class="btn btn-primary ">Save and Create another</button>
				</div>
...
<script>
$(function() {
	$('#btn-create-another').click(function(){		
		$('#another').val(1);		
	});
});
</script>