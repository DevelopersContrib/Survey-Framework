 ...
 <section>
	...
	<div class="calltoaction">
		<div class="container">
		  <div class="row">
			<div class="col-md-6">
			  <span><?php echo $count["polls"] ?></span> <?php echo e("Polls were created and successfully delivered.") ?>
			</div>
			<div class="col-md-6">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					...
					<ul class="list-unstyled ul-polls">
						<?php
									...
									<div class="col-xs-7 ">
										<span class="ellipsis pq-content-ttle">
											<span style="display:inline-block;">
												<img src="http://d2qcctj8epnr7y.cloudfront.net/images/jayson/forum_read.png">
											</span>
