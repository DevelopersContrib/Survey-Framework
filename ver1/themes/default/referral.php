        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
                ...
                <div class="padd-banner" style="border-radius: 10px;background:rgba(0,0,0,0.8);">
                    <iframe class="center-block" src="http://referrals.contrib.com/aff_index.php?affiliate=<?=$domain?>" width="710px" height="1050px" scrolling="auto" frameborder="0" seamless></iframe>
                    <div class="banner-main">
                        ...
                        <textarea class="text-left form-control" rows="3" onclick="this.focus();this.select()" readonly="readonly">
                            <a href="http://referrals.contrib.com/idevaffiliate.php?id=<?=$domain_affiliate_id?>" target="_blank">
                                <img style="border:0px" src="http://referrals.contrib.com/banners/badge-contrib-2.png" width="150" height="150" alt="Proud Member of Contrib">
                            </a>
                        </textarea>
                    </div>
                    <div class="banner-main">
